...
#
# - Install
#     powershell.exe -Command "Invoke-RestMethod -Uri "https://raw.githubusercontent.com/koginoadm/wsl/master/service/cron.bat" | Out-File -Encoding utf8 "$env:USERPROFILE\cron.bat""
#
# - Reference
#     
#
